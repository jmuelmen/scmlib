...
casename="DP_SCREAM.DYCOMS.rescomp.004a"
...
filelist_pre=["scream_dp_DYCOMSrf01.3km.004a",
          "scream_dp_DYCOMSrf01.1.5km.004a",
          "scream_dp_DYCOMSrf01.500m.004a"]          
          
filelist_append="1999-07-10-00000.nc"
   
# Easy ID for individual cases, for legends and plot titles
caselist=["3 km","1.5 km","500 m"]
